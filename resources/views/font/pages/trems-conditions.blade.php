...
@section('title', $data->meta_title ?? 'Terms & Conditions')
@section('meta_description', $data->meta_description ?? 'Terms & Conditions of our website')
@section('meta_keywords', $data->meta_keywords ?? 'terms, conditions, website, policy')

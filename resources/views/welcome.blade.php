...
<body class="direction-ltr">
    ...
    <div id="preloader">
        <div id="status">
            <img src="fontend/assets/images/preloader.svg" alt="img" />
        </div>
    </div>
    <!-- Preloader Area End -->
    ...
    <div class="hero-section">
        <div class="hero-slider">
            <div class="signle-slide"
                style="background-image: url('fontend/assets/images/slider/slider.jpg');">
                <div class="container">
                    <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4">
                        <div class="single-widget about-widget">
                            <a href="http://127.0.0.1:8000" class="footer-brand-logo mb-25"><img
                                    src="a{{ asset('fontend/ssets/images/logo.png') }}" alt="footer-logo" /></a>
